...
class ReportExtraContent(models.Model):
    ...
    append_extra_content = fields.Binary(string="Append Extra Content")
    model_id = fields.Many2one('ir.model', string="Model", required=True, domain=[('model', 'in', ['account.invoice', 'sale.order', 'stock.picking', 'purchase.order'])])
