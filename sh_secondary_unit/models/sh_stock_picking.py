...
class sh_stock_move(models.Model):
    ...
    sh_sec_done_qty = fields.Float("Secondary Done Qty", digits=dp.get_precision('Product Unit of Measure'))
...
class sh_stock_move_line(models.Model):
    ...
    sh_sec_qty = fields.Float("Secondary Qty", digits=dp.get_precision('Product Unit of Measure'))
    sh_sec_uom = fields.Many2one("product.uom", 'Secondary UOM', related="move_id.sh_sec_uom")
