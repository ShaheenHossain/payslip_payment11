...
class SaleReport(models.Model):
    ...
    def _select(self):
        return super(SaleReport, self)._select() + ", SUM(l.sh_sec_qty / COALESCE(cr.rate, 1.0)) AS sh_sec_qty" + ", l.sh_sec_uom as sh_sec_uom"

    def _group_by(self):
        return super(SaleReport, self)._group_by() + ", l.sh_sec_uom"
